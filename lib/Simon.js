...
export class Simon {
    ...
    say(colors) {
        this.colors = colors;
        this.audioPlayer.play(this.colors.slice(), this.longToneDurationMilliseconds, this.toneOffsetToNextOnsetDurationMilliseconds);
        lightUpAndPlayShiftedColorThenScheduleNotificationAfterMillisecondsIfMoreColors(this.presenter, this.audioPlayer, this.colors, this.timer, this.scheduledNotificationTimeMilliseconds_);
    }
    ...
    setLongToneDurationMilliseconds(x) { this.longToneDurationMilliseconds = x; }

    setToneOffsetToNextOnsetDurationMilliseconds(x) { this.toneOffsetToNextOnsetDurationMilliseconds = x; }
}